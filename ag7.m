...
CantDeTirasTotales=CantDeTirasTotales;
Datos=randint(CantDeTirasTotales,P,[1,CantDeTirasTotales]);     %generamos la poblacion inicial de soluciones, de manera RANDOM (Aleatoria)
% Datos=Datos.*randsrc(CantDeTirasTotales,P,[0,1;0.2,0.8]);      %agregamos ceros
...
% % % 
% % % for iteraciones=1:1             %======== INICIO DEL PRE PROCESANIENTO ==========   
...
% % % CantDeTirasTotales=CantDeTirasEstimada;
...
% Obtenemos la Sumatoria de desperdicios, recordar que menor valor numerico
% es mas Apto !!!      -->     MINIMIZAR
Desp=DespA+100*abs(DespB)+10*(CantDeTirasTotales-DespC);
